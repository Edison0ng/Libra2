            ...
            <div id="buku" class="tab-content max-w-5xl mx-auto space-y-6">
                ...
                <div id="live-library-container" class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
                    ...
                    <div class="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-200/60 dark:border-slate-800 overflow-hidden pb-3 hover:shadow-md transition-shadow cursor-pointer" 
                        onclick="openBookDetail('<?php echo e($book->title); ?>', '<?php echo e($book->author); ?>', '<?php echo e($book->image_url); ?>')">
                        
                        <img src="<?php echo e($book->image_url); ?>" alt="<?php echo e($book->title); ?>" class="w-full aspect-[4/5] object-cover">
                     
                        <div class="p-3">
                            <h4 class="book-title font-bold text-xs md:text-sm text-slate-800 dark:text-white line-clamp-1"><?php echo e($book->title); ?></h4>
                            <p class="book-author text-[11px] text-slate-400 mt-0.5"><?php echo e($book->author); ?></p>
                            <p class="text-[10px] text-slate-400">Tahun: <?php echo e($book->year); ?></p>
                            ...
                            <?php else: ?>
                                <span class="inline-block mt-2 px-2 py-0.5 bg-yellow-100 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-400 text-[9px] font-semibold rounded-full"><?php echo e($book->status); ?></span>
                            <?php endif; ?>
                        </div>
                    </div>
...
</html><?php /**PATH C:\Users\PC\Documents\Kerjaan Kuliah\SIstem informasi\Libra-Baru\resources\views/libra.blade.php ENDPATH**/ ?>